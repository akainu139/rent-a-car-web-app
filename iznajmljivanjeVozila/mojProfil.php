...
<ul class="nav nav-pills nav-justified detaljno mt-4">
    <li class="nav-item">
        <a class="nav-link active" data-toggle="pill" id="pill1" href="#osobniPodaci">Osobni podaci</a>
    </li>
    <li class="nav-item">
        <a class="nav-link" data-toggle="pill" id="pill2" href="#promjenaLozinke">Promjena lozinke</a>
    </li>
</ul>
...
<div class="tab-content">
    <div id="osobniPodaci" class="tab-pane active">
        ...
        <form action="mojProfil.php" method="post">
            <div class="row mt-3 red1">
            ...
            <input type="submit" name="predajSpremiPodatke" class="predajBtn mt-2" value="Spremi">
        </form>
    </div>
    ...
    <?php echo $greske2["status"]; ?>
        <form action="mojProfil.php" method="post">
            ...
            <input type="submit" name="predajSpremiLozinku" class="predajBtn mt-2" value="Spremi">
        </form>
    </div>
</div>
