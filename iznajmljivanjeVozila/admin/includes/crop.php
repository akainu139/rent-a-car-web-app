...
function image_resize($src, $dst, $width, $height, $crop=0){
  ...
  if(!list($w, $h) = getimagesize($src)) return " nije dodana. Datoteka mora biti jpg, jpeg ili png formata.";
  ...
  if($type == 'psd') return " nije dodana. Datoteka mora biti jpg, jpeg ili png formata.";
  switch($type){
    ...
    default : return " nije dodana. Datoteka mora biti jpg, jpeg ili png formata.";
  }

  // resize, određivanje da li se proporcionalno ili ne proporcionalno mijenja slika ($crop)
  if($crop){
    if($w < $width or $h < $height) return " je premalih dimenzija.";
    ...
    if($w < $width and $h < $height) return " je premalih dimenzija.";
