...
<!-- End of Content Wrapper -->
  ...
  <!-- Odjava Modal-->
  <div class="modal fade" id="odjavaModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="odjava.php">Potvrdi</a>
        </div>
      </div>
    </div>
  </div>
